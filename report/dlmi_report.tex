...
\begin{document}
	...
	The goal of this challenge is to determine if a patient has a lymphoproliferative disorder – a type of cancer. A mani- festation of this illness is an increased number of lympho- cytes, called lymphocytosis. But lymphocytosis can also be caused by other conditions such as an infection or acute stress. Thus, we must determine whether a patient with lym- phocytosis has cancer or not. To this end, the challenge provides a dataset of images of blood smears for 204 patiens. For each patient, we have access to dozens of images of lymphocytes, as well as the following clinical attributes: gender, age, and lymphocyte count.
